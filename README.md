...
> [!TIP]
> **Release channels**: Tagged releases run the cross-platform verification, tarball smoke, and Pi + LCM smoke before publication. Use the pinned GitHub release for reproducible installs; use the development form only when you intentionally want the moving `main` branch.
