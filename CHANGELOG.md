...
- **Reproducible Isolated Smoke Test**: Added `scripts/smoke-isolated-pi.sh` (`npm run smoke:pi`) to run fast CLI extension smoke tests under a temporary, isolated Pi agent directory.
